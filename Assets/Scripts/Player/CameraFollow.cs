...
public class CameraFollow : MonoBehaviour
{
    ...
    private void Start() {
        ...
        //commented out in order to properly follow midpoint of two balls
    ...
    private void Update() {
        ...
        if (GameObject.Find("Line").GetComponent<LineDrawer>().getDistance() <= theCamera.orthographicSize * 1.35f)
        {
        ...
        else if (GameObject.Find("Line").GetComponent<LineDrawer>().getDistance() >= theCamera.orthographicSize * 1.44f)
        {
            theCamera.orthographicSize = theCamera.orthographicSize + 2*Time.deltaTime;
